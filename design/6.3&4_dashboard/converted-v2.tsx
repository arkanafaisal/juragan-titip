...
export default function Dashboard() {
  return (
    <div className="bg-surface-bright text-on-surface font-body text-body antialiased h-screen overflow-hidden flex selection:bg-primary-container selection:text-on-primary-container">
        ...
        <nav className="hidden md:flex flex-col bg-surface-container-lowest border-r border-outline-variant fixed left-0 top-0 h-full z-40 transition-all duration-300 w-20 lg:w-60 py-md">
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full relative md:ml-20 lg:ml-60">
