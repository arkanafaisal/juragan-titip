  ...
  return (
    <div className={`flex items-center border border-outline-variant rounded-lg overflow-hidden bg-surface-container-lowest ${className} ${disabled ? 'opacity-50 grayscale' : ''}`}>
      <button 
        ...
        className="px-2 py-1  bg-surface-container-low hover:bg-surface-container-high text-text-secondary transition-colors disabled:opacity-50"
      >
      ...
      <input 
        ...
        className="w-full min-w-[32px]  max-w-[50px]  text-center font-data-md text-data-md outline-none bg-transparent py-1"
      />
      <button 
